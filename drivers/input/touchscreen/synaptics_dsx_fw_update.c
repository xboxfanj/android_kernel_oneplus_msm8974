...
int synaptics_rmi4_get_firmware_version(int vendor_id,int lcd_type_id) {
	if(vendor_id == TP_VENDOR_YOUNGFAST) {
		...
		if (lcd_type_id== LCD_VENDOR_JDI)
			...
			return 0;
			// return FIRMWARE_WINTEK_TRULY_VERSION;
		else if (lcd_type_id == LCD_VENDOR_SHARP)
			//return FIRMWARE_WINTEK_SHARP_VERSION;
			return 0;
		else
			return 0;
	}
